...
> Local passkey and WebAuthn lab without cloud IdP

**Author:** zAx4hub

## Problem

Local passkey and WebAuthn lab without cloud IdP. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`passkey-local-lab` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **policy** engine, CLI, examples, and tests.
